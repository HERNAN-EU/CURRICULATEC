...
<body>
    ...
    $columnas = ['nCtrl', 'nombre', 'contraseña', 'carrera', 'semestre'];
    $table = "registro";
    ...
    if (count($resultado) > 0) {
        ...
        $html .= '<th class="columnas">Contraseña</th>';
        $html .= '<th class="columnas">Carrera</th>';
        $html .= '<th class="columnas">Semestre</th>';
        ...
        $html .= '<tr><td colspan="7">EL REGISTRO BUSCADO NO EXISTE</td></tr>';
    }
    echo $html;
    ?>
</body>
