...
$id = $_GET['nCtrl'];
$Query = "SELECT * FROM registro WHERE nCtrl = '$id'";
    ...
    <div class="contenedor">
        ...
        <div class="content">
            <div class="contenido-tablas">
                ...
                <form class="formulario" action="modificarregistros.php" method="POST">
                    <table border="1">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            while ($row =$Result->fetch(PDO::FETCH_ASSOC)) { ?>
                                ...
                                <tr>
                                    <td>
                                        <label class="label-uptade" for="contraseña">Contraseña:</label>
                                    </td>
                                    <td>
                                        <input class="entrada-uptade" type="text" id="contraseña" name="contraseña" value="<?php echo $row["contraseña"] ?>" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label class="label-uptade" for="carrera">Carrera:</label>
                                    </td>
                                    <td>
                                        <input class="entrada-uptade" type="text" id="carrera" name="carrera" value="<?php echo $row["carrera"] ?>" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <label class="label-uptade" for="semestre">Semestre:</label>
                                    </td>
                                    <td>
                                        <input class="entrada-uptade" type="text" id="Semestre" name="semestre" value="<?php echo $row["semestre"] ?>" required>
                                    </td>
                                </tr>
                        </tbody>
                    <?php } ?>
